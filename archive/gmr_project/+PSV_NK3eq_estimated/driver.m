...
estim_params_.param_vals = [estim_params_.param_vals; 2, NaN, (-Inf), Inf, 2, 2, 0.2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 8, NaN, (-Inf), Inf, 1, 0.75, 0.03, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 3, NaN, (-Inf), Inf, 2, 1, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 5, NaN, (-Inf), Inf, 1, 0.7, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 6, NaN, (-Inf), Inf, 3, 2, 0.2, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 7, NaN, (-Inf), Inf, 3, 0.05, 0.01, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 9, NaN, (-Inf), Inf, 1, 0.2, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 10, NaN, (-Inf), Inf, 1, 0.2, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 11, NaN, (-Inf), Inf, 1, 0.7, 0.1, NaN, NaN, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 1, NaN, (-Inf), Inf, 5, NaN, NaN, 0, 2, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 2, NaN, (-Inf), Inf, 5, NaN, NaN, 0, 2, NaN ];
estim_params_.var_exo = [estim_params_.var_exo; 3, NaN, (-Inf), Inf, 5, NaN, NaN, 0, 2, NaN ];
...
options_.datafile = 'data_detrended.xls';
var_list_ = {};
...
save('PSV_NK3eq_estimated_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('PSV_NK3eq_estimated_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('PSV_NK3eq_estimated_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('PSV_NK3eq_estimated_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('PSV_NK3eq_estimated_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('PSV_NK3eq_estimated_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('PSV_NK3eq_estimated_results.mat', 'oo_recursive_', '-append');
end

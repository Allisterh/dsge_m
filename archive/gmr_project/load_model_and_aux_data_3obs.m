%% LOAD THE MODEL DATA
[QDATA,modelSeries]=xlsread('DataPSV_NK3eq_3obs.xlsx','ModelDataAll');
...
[DATA,Series,time_panel,dates_panel]=load_monthly_panel_3obs('DataPSV_NK3eq_3obs.xlsx',sheetName);

function isColCellStrArr = is_column_cell_string_array(data)
% This helper validates if the input is a column cell string array or not.
%
% INPUTS:
%   -> data: input data
%
% OUTPUTS
%   -> isColCellStrArr: true/false
%
% DETAILS: 
%   -> none
%
...
%% CHECK DATA
isColCellStrArr = (is_column_array(data)&&iscellstr(data));

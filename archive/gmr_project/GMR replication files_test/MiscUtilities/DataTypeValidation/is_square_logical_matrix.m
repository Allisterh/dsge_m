function isSquareLogicMat = is_square_logical_matrix(data)
% This helper validates if the input is a square logical matrix.
%
% INPUTS:
%   -> data: input data
%
% OUTPUTS
%   -> isSquareLogicMat: true/false
%
% DETAILS: 
%   -> none
%
...
%% CHECK DATA
isSquareLogicMat = (is_square_array(data)&&islogical(data));

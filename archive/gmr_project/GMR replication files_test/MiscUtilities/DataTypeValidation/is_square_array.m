function isSquareArr = is_square_array(data)
% This helper validates if the input is a square two-dim array or not.
%
% INPUTS:
%   -> data: input data
%
% OUTPUTS
%   -> isSquareArr: true/false
%
% DETAILS: 
%   -> none
%
...
%% CHECK DATA
isSquareArr = (is_two_dimensional(data)&&size(data,1)==size(data,2));

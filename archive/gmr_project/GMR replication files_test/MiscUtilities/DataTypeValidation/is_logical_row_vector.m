function isLogicRowVec = is_logical_row_vector(data)
% This helper validates if the input is a logical row vector.
%
% INPUTS:
%   -> data: input data
%
% OUTPUTS
%   -> isLogicRowVec: true/false
%
% DETAILS: 
%   -> none
%
...
%% CHECK DATA
isLogicRowVec = (is_row_array(data)&&islogical(data));

function isPosNums = is_numeric_and_all_positive(data)
% This helper validates if the input is positive numerics or not.
%
% INPUTS:
%   -> data: input data
%
% OUTPUTS
%   -> isPosNums: true/false
%
% DETAILS: 
%   -> none
%
...
%% CHECK DATA
isPosNums = (isnumeric(data)&&isequal(data>0,true(size(data))));

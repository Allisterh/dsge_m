function isRealInt = is_real_integer(data)
% This helper validates if the input is a real integer (scalar).
%
% INPUTS:
%   -> data: input data
%
% OUTPUTS
%   -> isRealInt: true/false
%
% DETAILS: 
%   -> none
%
...
%% CHECK DATA
isRealInt = (isscalar(data)&&is_real_integers(data));

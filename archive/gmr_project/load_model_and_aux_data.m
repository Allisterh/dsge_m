%% LOAD THE MODEL DATA
[QDATA,modelSeries]=xlsread('DataPSV_NK3eq.xlsx','ModelDataAll');
...
[DATA,Series,time_panel,dates_panel]=load_monthly_panel('DataPSV_NK3eq.xlsx',sheetName);
...
seriesX = [modelSeries(1,1:1),Series(1:end)];
...
Xfin = [modDatamFinal(:,1:1) DATA(:,1:end)];

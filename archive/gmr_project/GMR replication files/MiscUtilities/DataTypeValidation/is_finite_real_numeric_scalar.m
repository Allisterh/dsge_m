function isFinRealScalar = is_finite_real_numeric_scalar(data)
% This helper validates if the input is a finite real scalar.
%
% INPUTS:
%   -> data: input data
%
% OUTPUTS
%   -> isFinRealScalar: true/false
%
% DETAILS: 
%   -> none
%
...
%% CHECK DATA
isFinRealScalar = (is_real_numeric_scalar(data)&&is_finite_numerics(data));

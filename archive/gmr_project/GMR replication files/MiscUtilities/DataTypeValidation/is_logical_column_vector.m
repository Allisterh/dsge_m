function isLogicColVec = is_logical_column_vector(data)
% This helper validates if the input is a logical column vector.
%
% INPUTS:
%   -> data: input data
%
...
%% CHECK DATA
isLogicColVec = (is_column_array(data)&&islogical(data));

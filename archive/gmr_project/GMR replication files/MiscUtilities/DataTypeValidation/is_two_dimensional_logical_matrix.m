function isTwoDimLogicMat = is_two_dimensional_logical_matrix(data)
% This helper validates if the input is a two-dimensional logical matrix.
%
% INPUTS:
%   -> data: input data
%
% OUTPUTS
%   -> isTwoDimLogicMat: true/false
%
% DETAILS: 
%   -> none
%
...
%% CHECK DATA
isTwoDimLogicMat = (is_two_dimensional(data)&&islogical(data));

function isRealColVec = is_real_numeric_column_vector(data)
% This helper validates if the input is a real numeric column vector.
%
% INPUTS:
%   -> data: input data
%
% OUTPUTS
%   -> isRealColVec: true/false
%
% DETAILS: 
%   -> none
%
...
%% CHECK DATA
isRealColVec = (is_column_array(data)&&is_numeric_and_real(data));

function isRealScalar = is_real_numeric_scalar(data)
% This helper validates if the input is a real numeric scalar.
%
% INPUTS:
%   -> data: input data
%
% OUTPUTS
%   -> isRealScalar: true/false
%
% DETAILS: 
%   -> none
%
...
%% CHECK DATA
isRealScalar = (isscalar(data)&&is_numeric_and_real(data));
